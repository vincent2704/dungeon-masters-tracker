...
export class MonsterManualMonsters {
  ...
  static AARAKOCRA = new Monster(MonsterId.AARAKOCRA_ID,
    ...
    [new MonsterArmor(12)], new MonsterHitPoints(13, 3, DieType.D8), new MonsterSpeed(new Speed(20), new Speed(50)),
  ...
  static ABOLETH = new Monster(MonsterId.ABOLETH_ID,
    ...
    new MonsterSpeed(new Speed(10), new Speed(0), new Speed(40)),
  ...
  static DEVA = new Monster(MonsterId.DEVA_ID,
    ...
    [new MonsterArmor(17, [MonsterEquipment.NATURAL_ARMOR])], new MonsterHitPoints(136, 16, DieType.D8, 64), new MonsterSpeed(new Speed(30), new Speed(90)),
  ...
  static PLANETAR = new Monster(MonsterId.PLANETAR_ID,
    ...
    new MonsterSpeed(new Speed(40), new Speed(120)), new AbilitySet(24, 20, 24, 19, 22, 25),
  ...
  static SOLAR = new Monster(MonsterId.SOLAR_ID, 'Solar', MonsterSize.LARGE, MonsterType.CELESTIAL, [], Alignment.LAWFUL_GOOD,
    ...
    new MonsterSpeed(new Speed(50), new Speed(150)), new AbilitySet(26, 22, 26, 25, 25, 30),
  ...
  static ANIMATED_ARMOR = new Monster(MonsterId.ANIMATED_ARMOR_ID,
    ...
    new MonsterSpeed(new Speed(25)), new AbilitySet(14, 11, 13, 1, 3, 1),
  ...
  static FLYING_SWORD = new Monster(MonsterId.FLYING_SWORD_ID,
    ...
    new MonsterSpeed(new Speed(0), new Speed(50)), new AbilitySet(12, 15, 11, 1, 5, 1),
  ...
  static RUG_OF_SMOTHERING = new Monster(MonsterId.RUG_OF_SMOTHERING_ID,
    ...
    [new MonsterArmor(12)], new MonsterHitPoints(33, 6, DieType.D10), new MonsterSpeed(new Speed(10)),
  ...
  static AZER = new Monster(MonsterId.AZER_ID,
    ...
    new MonsterHitPoints(39, 6, DieType.D8, 12), new MonsterSpeed(new Speed(30)),
  ...
  static BANSHEE = new Monster(MonsterId.BANSHEE_ID,
    ...
    new MonsterHitPoints(58, 13, DieType.D8), new MonsterSpeed(new Speed(0), new Speed(40, SpeedDescription.HOVER)),
  ...
  static SPECTATOR = new Monster(MonsterId.SPECTATOR_ID,
   ...
   [new MonsterArmor(14, [MonsterEquipment.NATURAL_ARMOR])], new MonsterHitPoints(39, 6, DieType.D8, 12),
    new MonsterSpeed(new Speed(0), new Speed(30, SpeedDescription.HOVER)),
  ...
  static BUGBEAR = new Monster(MonsterId.BUGBEAR_ID,
    ...
    new MonsterSpeed(new Speed(30)), new AbilitySet(15, 14, 13, 8, 11, 9),
  ...
  static GOBLIN = new Monster(MonsterId.GOBLIN_ID,
    ...
    new MonsterSpeed(new Speed(30)), new AbilitySet(8, 14, 10, 10, 8, 8),
