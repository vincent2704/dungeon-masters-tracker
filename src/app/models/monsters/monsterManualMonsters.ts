...
export class MonsterManualMonsters {
  ...
  static AARAKOCRA = new Monster(MonsterId.AARAKOCRA_ID,
    ...
    [new MonsterArmor(12)], new MonsterHitPoints(13, 3, DieType.D8), new MonsterSpeeds([new MonsterSpeed(20), new MonsterSpeed(50, MovementType.FLY)]),
  ...
  static ABOLETH = new Monster(MonsterId.ABOLETH_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(10), new MonsterSpeed( 40, MovementType.SWIM)]),
  ...
  static DEVA = new Monster(MonsterId.DEVA_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(30), new MonsterSpeed(90, MovementType.FLY)]),
  ...
  static PLANETAR = new Monster(MonsterId.PLANETAR_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(40), new MonsterSpeed(120, MovementType.FLY)]),
  ...
  static SOLAR = new Monster(MonsterId.SOLAR_ID, 'Solar', MonsterSize.LARGE, MonsterType.CELESTIAL, [], Alignment.LAWFUL_GOOD,
    ...
    new MonsterSpeeds([new MonsterSpeed(50), new MonsterSpeed(150, MovementType.FLY)]),
  ...
  static FLYING_SWORD = new Monster(MonsterId.FLYING_SWORD_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(0), new MonsterSpeed(50, MovementType.FLY)]), new AbilitySet(12, 15, 11, 1, 5, 1),
  ...
  static ANKHEG = new Monster(MonsterId.ANKHEG_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(30), new MonsterSpeed(10, MovementType.BURROW)]),
  ...
  static BANSHEE = new Monster(MonsterId.BANSHEE_ID,
    ...
    new MonsterHitPoints(58, 13, DieType.D8), new MonsterSpeeds([new MonsterSpeed(0), new MonsterSpeed(40, MovementType.FLY, new MonsterSpeedDetails(MonsterSpeedNote.HOVER))]),
  ...
  static BEHIR = new Monster(MonsterId.BEHIR_ID,
    ...
    new MonsterHitPoints(168, 16, DieType.D12, 64), new MonsterSpeeds([new MonsterSpeed(50), new MonsterSpeed(40, MovementType.CLIMB)]),
  ...
  static SPECTATOR = new Monster(MonsterId.SPECTATOR_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(0), new MonsterSpeed(30, MovementType.FLY, new MonsterSpeedDetails(MonsterSpeedNote.HOVER))]),
  ...
  static WEREWOLF = new Monster(MonsterId.WEREWOLF_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(30, MovementType.LAND, new MonsterSpeedDetails(MonsterSpeedNote.IN_WOLF_FORM, 40))]),
  ...
  static NIGHTMARE = new Monster(MonsterId.NIGHTMARE_ID,
    ...
    new MonsterSpeeds([new MonsterSpeed(60), new MonsterSpeed(90, MovementType.FLY)]),
